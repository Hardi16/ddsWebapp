...
const DSCreateLeftPanePastMedicalHistory = (props) => {
  const [
  ...
  const renderSubsequentScreenPanes = (allPagesOfSelectedOne) => {
    ...
    allPagesOfSelectedOne = allPagesOfSelectedOne.filter(
      (item) => item["question"].trim() == "Past Medical History"
    );
                        ...
                        return (
                          <Button
                            ...
                            onClick={() => {
                              ...
                              pastMedicalHistoryObj[ele["itemName"]] =
                                pastMedicalHistoryObj[ele["itemName"]] == null
                                  ? {}
                                  : pastMedicalHistoryObj[ele["itemName"]];
                              if (
                                !(
                              ...
                              localStorage.setItem(
                                "pastMedicalHistoryObj",
                                JSON.stringify(pastMedicalHistoryObj)
                              );
...
export default DSCreateLeftPanePastMedicalHistory;

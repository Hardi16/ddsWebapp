...
import DashboardHiranandaniHospital from "./DashboardHiranandaniHospital";
import DashboardRDTHospital from "./DashboardRDTHospital";
  ...
  useEffect(() => {
    ...
    axios
      .put(
        hostAddress +
          currentServer +
          "/RestEasy/DashboardWebService/getPatientAppointmentCountList",
        data
      )
  ...
  return (
    <div>
      ...
      <div className={classes.mainContainer}>
        ...
        {/*Hiranandani  Dashbaord  */}
        {localStorage.getItem("roleId") == "31" &&
        localStorage.getItem("clinicId") == "600054006" ? (
          <div>
            <div className={classes.pageHeading}>
              <h3>Hiranandani Hospital </h3>
            </div>
            <DashboardHiranandaniHospital />
          </div>
        ) : null}
        {/*RDT Hospital  Dashbaord  */}
        {localStorage.getItem("roleId") == "31" &&
        localStorage.getItem("clinicId") == "600054178" ? (
          <div>
            <div className={classes.pageHeading}>
              <h3>RDT Hospitals </h3>
            </div>
            <DashboardRDTHospital />
          </div>
        ) : null}
